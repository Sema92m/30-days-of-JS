...
// container.style.gridTemplate = "repeat(17, 1fr) / repeat(6, 1fr)";
...
//     num.style.fontSize = "35px";
//     num.style.color = "white";
//     container.appendChild(num);
//     if (num.textContent % 2 !== 0) {
//         num.style.background = "#fdd31a";
//     }
// 	if (isPrime(i) === true) {
//         num.style.background = "#fd471a";
//     }
// }
...
// h1.textContent = 'word countries list';
// h1.style.textTransform = 'uppercase';
// h1.style.textAlign = 'center';

// h2.textContent = `Total number of countries: ${countriesFull.length}`;
// h2.style.textDecoration = 'underline';
// h2.style.textAlign = 'center';

// container.style.display = 'grid';
// container.style.gridTemplate = 'repeat(42, 1fr) / repeat(6, 1fr)';
// container.style.gap = '5px';
// container.style.margin = '10px';
...
// 	country.textContent = countriesFull[i].name;
// 	country.style.fontSize = '25px';
// 	country.style.border = '2px solid gray';
