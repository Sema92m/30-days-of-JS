...
// const str7 = 'He earns 5000 euro from salary per month, 10000 euro annual bonus, 15000 euro online courses per month.';
// let salaryArr = str7.match(/\d+/g);
// console.log(+salaryArr[0]+ +salaryArr[1]+ +salaryArr[2])