...
let counts = [];
function sortArrByLanguages(arr) {
    let resultLang = [];
    arr.forEach((elem) => resultLang.push(...elem.languages));
    let langSet = new Set(resultLang);
...
let populationArr = [];
let sumPopulations = [];
function sortArrByPopulation(arr) {
    for (let params of arr) {
        populationArr.push({
            name: params.name,
            population: params.population,
        });
        sumPopulations.push(params.population);
    }
