...
// console.log(countriesFull.sort((a,b) => b.population- a.population));
// console.log(countriesFull.sort((a,b) => b.name - a.name));
// console.log(countriesFull.sort(function (a, b) {
